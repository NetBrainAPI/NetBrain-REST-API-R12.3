...
# Update Network Definition API Design

## ***PUT*** V1/network-definition
This API is used to update the existing Network Definition.

## Detail Information

> **Title** : Update Network Definition<br>
...
try:
    ...
    if response.status_code == 200:
        ...
        print ("Failed to Update Network Definition! - " + str(response.text))
