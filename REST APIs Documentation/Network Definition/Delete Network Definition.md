...
# Delete Network Definition API Design

## ***DELETE*** V1/network-definition
This API is used to delete the existing Network Definition.

## Detail Information

> **Title** : Delete Network Definition<br>
...
|ID*|string|ID of the Network Definition. <br> This can be retrieved from `Get Network Definition API`.|
...
try:
    ...
    if response.status_code == 200:
        ...
        print ("Failed to Delete Network Definition! - " + str(response.text))
